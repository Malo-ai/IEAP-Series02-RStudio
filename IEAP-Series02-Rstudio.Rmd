...
ggplot(PrePost, aes(x = time, y = perf)) +
  ...
  labs(title = "Performance Before and After Rehabilitation",
       y = "Performance")
```
A paired t-test was conducted to compare performance before and after the cardiac rehabilitation program. There was a significant increase in performance after the intervention, t(7) = -5.40, p = 0.001, with a mean difference of -2.5 (95% CI [-3.59, -1.41]). This indicates that the rehabilitation program had a positive effect on participant performance.
